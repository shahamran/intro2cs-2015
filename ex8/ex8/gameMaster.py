...
# * added a binded key 'h' for the missile (lines 50,150,388) #
# * added method self.add_missile (line 288)                  #
###############################################################
from turtle import *
...
class GameMaster:
    ...
    **This was already done for you, look at the asteroidsMain.py file**
    ...
    def _bind_keys(self):
        ...
        self._originalGame.bind_key("h", self._handle_missile) ###
    ...
    def _handle_missile(self): ### BONUS ###
        self._missileClicks += 1
    ...
    ### BONUS ###
    def add_missile(self, x,y,xSpeed,ySpeed,angle,asteroid,axis_min,axis_max):
        missile = HeatSeeker(self._cv, x, y, xSpeed, ySpeed, \
                              angle,asteroid,axis_min,axis_max)
        self.torpedos.append(missile)
    ...
    def is_missile_pressed(self): ###
        """
        :returns: True if the fire key was pressed, else False
        """
        res = self._missileClicks > 0
        self._missileClicks -= 1 if res else 0
        return res
